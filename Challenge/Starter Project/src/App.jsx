...
function App() {
  ...
  // Base counter used by the starter.
  const pendingCount = tasks.filter((t) => t.status === 'Pending').length;

  // TODO (Tier 1 - Feature 1): Calculate doneCount and totalCount,
  // then pass both values to Header for the improved task counter.
  ...
  return (
    ...
    <div className="app">
      <Header
        ...
        // TODO (Tier 1 - Feature 1): Pass doneCount and totalCount here.
